  ...
  while True:
    try:
      ...
      if (Stunde >= H_sleep) or (Stunde <= H_wakeup-1) or (Stunde == H_wakeup and Minute <= M_wakeup-1):
        ...
        if (Tag[-3:] == 'Fri' and Stunde >= 22) or (Tag[-3:] == 'Sat') or (Tag[-3:] == 'Sun'): 
      ...
      if T > 0:
        ...
        #wenn er das erste mal aufwacht zaehlt er die geschlafene Zeit auch als processing time und gibt deswegen 
        #eine Warnung aus. das muesste man nochmal beheben
    except:
      continue
